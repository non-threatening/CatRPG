...
func _dream_tree() -> void:
	material.set_shader_parameter( "color1", Color(0.047, 0.561, 0.0, 0.666) )
	material.set_shader_parameter( "color2", Color(0.067, 0.69, 0.0, 0.666) )
	material.set_shader_parameter( "color3", Color( 0.35, 0.99, 0.33, 0.74 ) )
