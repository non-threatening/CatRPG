...
@export var key_item : ItemData # The kind of item that can open the door (self)
...
@onready var is_open_data: PersistantDataHandler = $PersistantDataHandler # Persistance file
...
func set_state() -> void:
	is_open = is_open_data.value # persistant data handler
	if is_open:
